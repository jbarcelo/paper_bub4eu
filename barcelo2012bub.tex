...
\IEEEauthorblockA{\IEEEauthorrefmark{1} Universitat Pompeu Fabra}
\IEEEauthorblockA{\IEEEauthorrefmark{2} Gufi.net}
...
These community networks are typically led by technology enthusiasts and with a strong to contribute to the community.
To succeed and grow, it is important to involve other people that might not be, initially, technologically savvy.
...
Each community network has its own \emph{developers}, but all the participants in different communities share a set of principles, good practices and high-level objectives.
Similarly, community networks activists are normally part of a local community network, but they also collaborate at a higher level with other community networks.
...
The present paper covers the project definitions and goals, as well as the pilot proposals identified during the first 6 months of the papers.
In our future works, we will provide a more detailed description of the executed pilots an results of the project.

The particularity of BuB is that the beneficiaries of the network (individuals or organizations) play an active rol in the network planning, funding, deployment and maintenance.
...
The growth of \emph{guifi.net} and the consequent increment of Internet penetration in the area in which has developed is studied in \cite{oliver2010wca}.
